...
impl HeikinAshiBuilder {
	...
	pub fn apply_slices(
		...
		low: &[f64],
		close: &[f64],
	) -> Result<HeikinAshiOutput, HeikinAshiError> {
...
pub fn heikin_ashi_with_kernel(input: &HeikinAshiInput, kernel: Kernel) -> Result<HeikinAshiOutput, HeikinAshiError> {
	...
	unsafe {
		match chosen {
			Kernel::Scalar | Kernel::ScalarBatch => heikin_ashi_scalar(open, high, low, close, first_valid_idx),
			#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
			Kernel::Avx2 | Kernel::Avx2Batch => heikin_ashi_avx2(open, high, low, close, first_valid_idx),
			#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
			Kernel::Avx512 | Kernel::Avx512Batch => heikin_ashi_avx512(open, high, low, close, first_valid_idx),
			_ => unreachable!(),
		}
	}
}
...
#[inline]
pub unsafe fn heikin_ashi_scalar(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_avx2(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_avx512(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[inline]
pub fn heikin_ashi_indicator_with_kernel(
	input: &HeikinAshiInput,
	kernel: Kernel,
) -> Result<HeikinAshiOutput, HeikinAshiError> {
...
impl HeikinAshiBatchBuilder {
	...
	pub fn apply_slices(
		...
		low: &[f64],
		close: &[f64],
	) -> Result<HeikinAshiBatchOutput, HeikinAshiError> {
...
pub fn heikin_ashi_batch_with_kernel(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[inline(always)]
pub fn heikin_ashi_batch_slice(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[inline(always)]
pub fn heikin_ashi_batch_par_slice(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[inline]
pub unsafe fn heikin_ashi_row_scalar(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_row_avx2(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_row_avx512(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_row_avx512_short(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn heikin_ashi_row_avx512_long(
	open: &[f64],
	high: &[f64],
	low: &[f64],
	close: &[f64],
...
mod tests {
	...
	fn check_ha_accuracy(test_name: &str, kernel: Kernel) -> Result<(), Box<dyn std::error::Error>> {
		...
		let expected_last_five_open: [f64; 5] = [59348.5, 59277.5, 59233.0, 59110.5, 59097.0];
		let expected_last_five_high: [f64; 5] = [59348.5, 59405.0, 59304.0, 59310.0, 59236.0];
		let expected_last_five_low: [f64; 5] = [59001.0, 59084.0, 58932.0, 58983.0, 58299.0];
		let expected_last_five_close: [f64; 5] = [59221.75, 59238.75, 59114.25, 59121.75, 58836.25];
	...
	fn check_ha_batch_accuracy(test_name: &str, kernel: Kernel) -> Result<(), Box<dyn std::error::Error>> {
		...
		let output = HeikinAshiBatchBuilder::new().kernel(kernel).apply_candles(&candles)?;
		let len = output.open.len();
