    ...
    unsafe {
        match chosen {
            ...
            Kernel::Avx2 | Kernel::Avx2Batch => {
                kurtosis_avx2(data, period, first, &mut out)
            }
            #[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
            Kernel::Avx512 | Kernel::Avx512Batch => {
                kurtosis_avx512(data, period, first, &mut out)
            }
            _ => unreachable!(),
        }
    }
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn kurtosis_avx512_short(
    data: &[f64],
    period: usize,
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn kurtosis_avx512_long(
    data: &[f64],
    period: usize,
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
unsafe fn kurtosis_row_avx512_short(
    data: &[f64],
    first: usize,
    period: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
unsafe fn kurtosis_row_avx512_long(
    data: &[f64],
    first: usize,
    period: usize,
    out: &mut [f64],
...
mod tests {
    ...
    fn check_kurtosis_streaming(test_name: &str, kernel: Kernel) -> Result<(), Box<dyn Error>> {
        ...
        let input = KurtosisInput::from_candles(
            &candles,
            "close",
            KurtosisParams { period: Some(period) },
        );
