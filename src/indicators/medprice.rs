    ...
    unsafe {
        match chosen {
            ...
            Kernel::Avx2 | Kernel::Avx2Batch => {
                medprice_avx2(high, low, first_valid_idx, &mut out)
            }
            #[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
...
// Row functions
#[inline(always)]
pub unsafe fn medprice_row_scalar(
    high: &[f64],
    low: &[f64],
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn medprice_row_avx2(
    high: &[f64],
    low: &[f64],
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn medprice_row_avx512(
    high: &[f64],
    low: &[f64],
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn medprice_row_avx512_short(
    high: &[f64],
    low: &[f64],
    first: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn medprice_row_avx512_long(
    high: &[f64],
    low: &[f64],
    first: usize,
    out: &mut [f64],
...
impl MedpriceBatchBuilder {
    ...
    pub fn apply_candles(self, c: &Candles, high_src: &str, low_src: &str) -> Result<MedpriceBatchOutput, MedpriceError> {
...
fn medprice_batch_inner(
    ...
    unsafe { medprice_row_scalar(high, low, first, &mut values); }

    Ok(MedpriceBatchOutput {
        values,
        rows,
        cols,
    })
...
mod tests {
    ...
    let last_expected = [
        59166.0, 59244.5, 59118.0, 59146.5, 58767.5
    ];
