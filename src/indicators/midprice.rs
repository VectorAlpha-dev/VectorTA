...
impl<'a> MidpriceInput<'a> {
	#[inline]
	pub fn from_candles(candles: &'a Candles, high_src: &'a str, low_src: &'a str, params: MidpriceParams) -> Self {
		Self {
...
pub fn midprice_with_kernel(input: &MidpriceInput, kernel: Kernel) -> Result<MidpriceOutput, MidpriceError> {
	...
	unsafe {
		match chosen {
			Kernel::Scalar | Kernel::ScalarBatch => midprice_scalar(high, low, period, first_valid_idx, &mut out),
			#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
...
#[inline]
pub fn midprice_scalar(high: &[f64], low: &[f64], period: usize, first_valid_idx: usize, out: &mut [f64]) {
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub fn midprice_avx2(high: &[f64], low: &[f64], period: usize, first_valid_idx: usize, out: &mut [f64]) {
	midprice_scalar(high, low, period, first_valid_idx, out);
}

#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub fn midprice_avx512(high: &[f64], low: &[f64], period: usize, first_valid_idx: usize, out: &mut [f64]) {
	if period <= 32 {
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn midprice_avx512_short(high: &[f64], low: &[f64], period: usize, first_valid_idx: usize, out: &mut [f64]) {
	midprice_scalar(high, low, period, first_valid_idx, out);
}

#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline]
pub unsafe fn midprice_avx512_long(high: &[f64], low: &[f64], period: usize, first_valid_idx: usize, out: &mut [f64]) {
	midprice_scalar(high, low, period, first_valid_idx, out);
}
...
pub fn midprice_batch_with_kernel(
	...
	let kernel = match k {
		...
		_ => return Err(MidpriceError::InvalidPeriod { period: 0, data_len: 0 }),
	};
...
#[inline(always)]
pub unsafe fn midprice_row_scalar(high: &[f64], low: &[f64], first: usize, period: usize, out: &mut [f64]) {
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn midprice_row_avx2(high: &[f64], low: &[f64], first: usize, period: usize, out: &mut [f64]) {
	midprice_row_scalar(high, low, first, period, out);
}

#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn midprice_row_avx512(high: &[f64], low: &[f64], first: usize, period: usize, out: &mut [f64]) {
	if period <= 32 {
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn midprice_row_avx512_short(high: &[f64], low: &[f64], first: usize, period: usize, out: &mut [f64]) {
	midprice_row_scalar(high, low, first, period, out);
}

#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
pub unsafe fn midprice_row_avx512_long(high: &[f64], low: &[f64], first: usize, period: usize, out: &mut [f64]) {
	midprice_row_scalar(high, low, first, period, out);
}
...
impl MidpriceStreamPy {
	...
	fn new(period: usize) -> PyResult<Self> {
		let params = MidpriceParams { period: Some(period) };
		let stream = MidpriceStream::try_new(params).map_err(|e| PyValueError::new_err(e.to_string()))?;
...
pub fn midprice_into_slice(
	...
	match chosen {
		Kernel::Scalar | Kernel::ScalarBatch => midprice_scalar(high, low, period, first_valid_idx, dst),
		#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
...
pub fn midprice_batch_js(high: &[f64], low: &[f64], config: JsValue) -> Result<JsValue, JsValue> {
	let config: MidpriceBatchConfig =
...
mod tests {
	...
	fn check_midprice_zero_period(test_name: &str, kernel: Kernel) -> Result<(), Box<dyn Error>> {
		...
		assert!(res.is_err(), "[{}] MIDPRICE should fail with zero period", test_name);
		Ok(())
	}
