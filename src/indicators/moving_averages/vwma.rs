...
// VWMA-specific VRAM handle for Python with CAI v3 + DLPack
#[cfg(all(feature = "python", feature = "cuda"))]
...
impl VwmaDeviceArrayF32Py {
    ...
    fn __dlpack__<'py>(
        ...
        // Move DeviceBuffer into capsule-owned holder (one-shot)
        let buf = self
            .buf
            .take()
