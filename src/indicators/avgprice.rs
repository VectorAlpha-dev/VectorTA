...
mod tests {
    ...
    fn test_avgprice_accuracy() {
        let candles = Candles {
            ...
            open_f32: vec![100., 101., 102., 103., 104.],
            high_f32: vec![110., 111., 112., 113., 114.],
            low_f32: vec![90., 91., 92., 93., 94.],
            close_f32: vec![105., 106., 107., 108., 109.],
            volume_f32: vec![1000., 1000., 1000., 1000., 1000.],
            hl2_f32: vec![100., 101., 102., 103., 104.],
            hlc3_f32: vec![100., 101., 102., 103., 104.],
            ohlc4_f32: vec![100., 101., 102., 103., 104.],
            hlcc4_f32: vec![100., 101., 102., 103., 104.],
        };
