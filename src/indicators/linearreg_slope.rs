...
pub fn linearreg_slope_with_kernel(input: &LinearRegSlopeInput, kernel: Kernel) -> Result<LinearRegSlopeOutput, LinearRegSlopeError> {
...
#[inline(always)]
unsafe fn linearreg_slope_row_scalar(
    data: &[f64],
    first: usize,
    period: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
unsafe fn linearreg_slope_row_avx2(
    data: &[f64],
    first: usize,
    period: usize,
    out: &mut [f64],
...
#[cfg(all(feature = "nightly-avx", target_arch = "x86_64"))]
#[inline(always)]
unsafe fn linearreg_slope_row_avx512(
    data: &[f64],
    first: usize,
    period: usize,
    out: &mut [f64],
...
impl LinearRegSlopeStream {
    ...
    pub fn update(&mut self, value: f64) -> Option<f64> {
        ...
        Some(if denominator.abs() < f64::EPSILON { f64::NAN } else { numerator / denominator })
    }
}
