...
impl CudaPercentileNearestRank {
    ...
    pub fn pnr_batch_dev(
        ...
        // Pinned host buffers
        let h_prices =
            LockedBuffer::from_slice(data_f32).map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        let h_periods =
            LockedBuffer::from_slice(&periods).map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        let h_percs =
            LockedBuffer::from_slice(&percs).map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        ...
        let mut d_scratch: DeviceBuffer<f32> =
            unsafe { DeviceBuffer::uninitialized(combos.len() * max_len) }
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        ...
        unsafe {
            d_prices
                ...
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
            d_periods
                .async_copy_from(h_periods.as_slice(), &self.stream)
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
            d_percs
                .async_copy_from(h_percs.as_slice(), &self.stream)
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        }
    ...
    pub fn pnr_many_series_one_param_time_major_dev(
        ...
        // Pinned host buffers
        let h_prices =
            LockedBuffer::from_slice(data_tm_f32).map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        let h_firsts =
            LockedBuffer::from_slice(&firsts).map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        ...
        unsafe {
            d_prices
                ...
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
            d_firsts
                .async_copy_from(h_firsts.as_slice(), &self.stream)
                .map_err(|e| CudaPnrError::Cuda(e.to_string()))?;
        }
