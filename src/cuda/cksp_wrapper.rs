...
impl CudaCksp {
    ...
    pub fn cksp_batch_dev(
        ...
        // H2D
        let d_high =
            DeviceBuffer::from_slice(high).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_low =
            DeviceBuffer::from_slice(low).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_close =
            DeviceBuffer::from_slice(close).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_p =
            DeviceBuffer::from_slice(&p_i32).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_x =
            DeviceBuffer::from_slice(&x_f32).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_q =
            DeviceBuffer::from_slice(&q_i32).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
    ...
    pub fn cksp_many_series_one_param_time_major_dev(
        ...
        let d_high =
            DeviceBuffer::from_slice(high_tm).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_low =
            DeviceBuffer::from_slice(low_tm).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
        let d_close =
            DeviceBuffer::from_slice(close_tm).map_err(|e| CudaCkspError::Cuda(e.to_string()))?;
