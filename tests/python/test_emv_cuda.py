...
class TestEmvCuda:
    ...
    def test_emv_cuda_batch_matches_cpu(self, test_data):
        ...
        # CPU baseline aligned to FP32 input (to match GPU semantics)
        cpu = ti.emv(
        ...
        # Slightly looser tol because EMV involves division by volume and range
