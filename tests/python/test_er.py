...
# Load test data
def load_test_data():
    """Load the standard test dataset"""
    csv_path = Path(__file__).parent.parent.parent / "src" / "data" / "2018-09-01-2024-Bitfinex_Spot-4h.csv"
...
class TestER:
    ...
    def test_er_basic(self, test_data):
        ...
        result = ta_indicators.er(test_data, period=5)
    ...
    def test_er_with_different_periods(self, test_data):
        ...
        for period in [5, 10, 20, 50]:
            result = ta_indicators.er(test_data, period=period)
            assert len(result) == len(test_data)
            # Check warmup period
    ...
    def test_er_zero_period(self, test_data):
        ...
        with pytest.raises(Exception, match="Invalid period"):
            ta_indicators.er(test_data, period=0)
    ...
    def test_er_reinput(self, test_data):
        ...
        # First pass
        first_result = ta_indicators.er(test_data, period=5)
        assert len(first_result) == len(test_data)
        
        # Second pass - apply ER to ER output
        second_result = ta_indicators.er(first_result, period=5)
    ...
    def test_er_streaming_vs_batch(self, test_data):
        ...
        # Batch calculation
        batch_result = ta_indicators.er(test_data, period=period)
        
        # Streaming calculation
        stream = ta_indicators.ErStream(period=period)
        stream_result = []
    ...
    def test_er_batch_single_period(self, test_data):
        ...
        result = ta_indicators.er_batch(test_data, period_range=(5, 5, 0))
        ...
        single_result = ta_indicators.er(test_data, period=5)
    ...
    def test_er_batch_multiple_periods(self, test_data):
        ...
        result = ta_indicators.er_batch(data_subset, period_range=(5, 15, 5))
        ...
        for i, period in enumerate([5, 10, 15]):
            ...
            single_result = ta_indicators.er(data_subset, period=period)
    ...
    def test_er_batch_edge_cases(self):
        ...
        # Single value sweep
        result = ta_indicators.er_batch(data, period_range=(5, 5, 1))
        assert len(result['values']) == 10
        assert result['periods'] == [5]
        
        # Step larger than range
        result = ta_indicators.er_batch(data, period_range=(5, 7, 10))
    ...
    def test_er_with_kernel_parameter(self, test_data):
        ...
        result_auto = ta_indicators.er(test_data, period=5)
        
        # Test with scalar kernel
        result_scalar = ta_indicators.er(test_data, period=5, kernel="scalar")
    ...
    def test_er_consistency(self):
        ...
        result = ta_indicators.er(trending_data, period=5)
        ...
        result = ta_indicators.er(choppy_data, period=5)
