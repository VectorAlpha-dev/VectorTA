...
class TestCmo:
    ...
    def test_cmo_partial_params(self, test_data):
        ...
        # Test with default params (None)
        result = ta_indicators.cmo(close)  # Using default period=14
    ...
    def test_cmo_batch(self, test_data):
        ...
        # Expected values from accuracy test
        expected_last_five = [
            -13.152504931406101,
            -14.649876201213106,
            -16.760170709240303,
    ...
    def test_cmo_batch_multiple_periods(self, test_data):
        ...
        close = test_data['close'][:1000]  # Use subset for speed
    ...
    def test_cmo_kernel_parameter(self, test_data):
        ...
        close = test_data['close'][:1000]  # Use subset
