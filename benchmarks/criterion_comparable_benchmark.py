...
class CriterionComparableBenchmark:
    ...
    def run_python_benchmarks(self):
        ...
        indicators = [
            ...
            ('wto', lambda: my_project.wto(data['close'], 10, 21)),
            ...
            ('ehlers_ecema', lambda: my_project.ehlers_ecema(data['close'], 20, 50)),
            ('ehlers_itrend', lambda: my_project.ehlers_itrend(data['close'], 20, 48)),
            ('ehlers_kama', lambda: my_project.ehlers_kama(data['close'], 14)),
            ...
            ('devstop', lambda: my_project.devstop(data['high'], data['low'], 20, 2.0, 0, 'long', 'sma')),
            ...
            ('dm', lambda: my_project.dm(data['high'], data['low'], 14)),
        ...
        batch_indicators = [
            ...
            ('ad_batch', lambda: my_project.ad_batch(data['high'], data['low'], data['close'], data['volume'])),
            ...
            ('wilders_batch', lambda: my_project.wilders_batch(data['close'], (5, 25, 5))),
            ...
            ('ehlers_ecema_batch', lambda: my_project.ehlers_ecema_batch(data['close'], (10, 30, 5), (30, 60, 10))),
            ('ehlers_itrend_batch', lambda: my_project.ehlers_itrend_batch(data['close'], (12, 20, 4), (40, 50, 5))),
            ('ehlers_kama_batch', lambda: my_project.ehlers_kama_batch(data['close'], (14, 50, 1))),
            ...
            ('devstop_batch', lambda: my_project.devstop_batch(data['high'], data['low'], (15, 25, 5), (1.5, 2.5, 0.5), (0, 2, 1))),
            ...
            ('lpc_batch', lambda: my_project.lpc_batch(data['high'], data['low'], data['close'], data['close'], (20, 60, 10), (1.0, 2.0, 0.5), (1.0, 2.0, 0.5), "adaptive", 60)),
            ...
            ('macz_batch', lambda: my_project.macz_batch(data['high'], data['low'], data['close'], data['volume'], (10, 14, 2), (20, 30, 5), (7, 11, 2), (18, 22, 2), (20, 30, 5), (0.8, 1.2, 0.2), (0.8, 1.2, 0.2), False, (0.01, 0.03, 0.01))),
            ...
            ('acosc_batch', lambda: my_project.acosc_batch(data['high'], data['low'])),
            ...
            ('dm_batch', lambda: my_project.dm_batch(data['high'], data['low'], (14, 14, 1))),
            ...
            ('pma_batch', lambda: my_project.pma_batch(data['close'])),
            ('ott_batch', lambda: my_project.ott_batch((data['high'] + data['low'] + data['close']) / 3, (2, 4, 1), (1.0, 2.0, 0.2), ["VAR", "SMA", "EMA"])),
            ...
            ('vwap_batch', lambda: my_project.vwap_batch(data['timestamps'], data['volume'], data['close'], ['1d', '1h', '30m'])),
            ...
            ('rsx_batch', lambda: my_project.rsx_batch(data['close'], (10, 20, 5))),
            ...
            ('net_myrsi_batch', lambda: my_project.net_myrsi_batch(data['close'], (10, 20, 2))),
            ...
            ('prb_batch', lambda: my_project.prb_batch(data['close'], True, (5, 15, 5), (50, 150, 50), (1, 3, 1), (0, 2, 1))),
            ('rocr_batch', lambda: my_project.rocr_batch(data['close'], (5, 15, 5))),
            ...
            ('fvg_trailing_stop_batch', lambda: my_project.fvg_trailing_stop_batch(data['high'], data['low'], data['close'], (3, 5, 1), (1, 3, 1), (False, True))),
