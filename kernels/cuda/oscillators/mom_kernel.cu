...
// Semantics:
// - Warmup: first_valid + period - 1 indices are NaN (match scalar)
// - No special NaN handling beyond default FP rules; mid-stream NaNs propagate
// - FP32 compute to match GPU infra
